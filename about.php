...
<head>
    ...
    <title> Expressions Architects | About </title>
    ...
    <main>
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="about-caption mb-50">
                            ...
                            <div class="section-tittle section-tittle2 mb-35">
                                <span>About Us</span>
                                <h2># Years Of Experience in this area</h2>
                            </div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ex eorum enim scriptis et institutis cum omnis doctrina liberalis, omnis historia. Quis enim confidit semper sibi illud stabile et firmum permansurum, quod fragile et caducum sit? Duo Reges: constructio interrete. Quia dolori non voluptas contraria est, sed doloris privatio.</p>
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="about-img ">
                            <div class="about-font-img ">
                                <img src="assets/img/gallery/about_p.jpg" alt="">
                            </div>
        ...
        <div class="starups-area testimonial-area fix">
            ...
            <div class="starups-img">
                <div class="play-btn"><a class="popup-video" href="https://www.youtube.com/watch?v=TlMUknHQYLU"><i class="flaticon-null-3"></i></a></div>
            </div>
            <!-- Right Contents -->
            <div class="starups">
                <!--? Testimonial Start -->
                        ...
                        <div class="testimonial-caption ">
                            ...
                            <div class="testimonial-founder d-flex align-items-center justify-content-center mb-40">
                                <div class="founder-img">
                                    <img src="assets/img/gallery/ex1_test.jpg" alt="">
                                </div>
                            ...
                            <div class="testimonial-top-cap">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Animi enim quoque dolores percipiet omnibus partibus maiores quam corporis. Quam multa vitiosa! summum enim bonum et malum vagiens puer utra voluptate diiudicabit, stante an movente? Quid enim tanto opus est instrumento in optimis artibus comparandis? Tamen a proposito, inquam, aberramus. </p>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="assets/img/gallery/ex1.jpg" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="assets/img/gallery/ex2.jpg" alt="">
                            </div>
                            <div class="team-caption">
                                <h3><a href="#">John Doe</a></h3>
                                <span>Job Title</span>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="assets/img/gallery/ex3.png" alt="">
                            </div>
                            <div class="team-caption">
                                <h3><a href="#">John Doe</a></h3>
                                <span>Job Title</span>
