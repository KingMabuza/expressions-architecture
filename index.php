...
<head>
    ...
    <title> Expressions Architecture </title>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="assets/img/logo/loader.jpg" alt="Expressions Architects">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="index.php"><img src="assets/img/logo/expressions-logo.png" alt="logo"></a>
                            </div>
                        </div>
    ...
    <main>
		...
		<div class="slider-area">
			<div class="slider-full-active owl-carousel custom-dots">
				<div class="slide-full slider-height d-flex align-items-center" style="background-image: url(assets/img/hero/background1.jpg);">
					<div class="container">
						<div class="row">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-7 col-lg-8 col-md-11 col-sm-11">
                        <div class="section-tittle section-tittle3  text-center mb-90">
                            ...
                            <h2>We provide best interior solution for you</h2>
                        </div>
                    </div>
                </div>
                <!-- Section caption -->
